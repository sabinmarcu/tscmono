...
export type WorkspaceRootConfig = Required & Optional;
...
export type JSONSchemaForTheTypeScriptCompilerSConfigurationFile1 = {
  /**
   * Instructs the TypeScript compiler how to compile .ts files.
   */
  compilerOptions?: {
...
export interface Optional {
  ...
  presets?: {
    [k: string]: JSONSchemaForTheTypeScriptCompilerSConfigurationFile1;
  };
  [k: string]: unknown;
}
